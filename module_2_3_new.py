...
# Исходные данные: my_list = [42, 69, 0, 322, 13, 0, 99, -5, 9, 8, 7, -6, 5]
...
# Примечания:
# Чтобы перебрать список вам понадобиться обращение по индексу,
# запишите в отдельную переменную начальное значение - 0.
# Чтобы не выйти за границу списка, в условии цикла while рекомендуется сравнивать
# текущий индекс и длину списка (функция len()).
