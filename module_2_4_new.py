...
# что выбранное число не делится ни на что в диапазоне от 2 до этого числа (не включительно).
...
# как is_prime, в кругах разработчиков называются переменными-флагами (flag).
